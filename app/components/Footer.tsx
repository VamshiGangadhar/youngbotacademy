...
export function Footer() {
  return (
    <footer className="bg-[#112240] text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                <Mail className="w-6 h-6 mr-3 text-[#64ffda]" />
                <a
              ...
              <li className="flex items-center">
                <Phone className="w-6 h-6 mr-3 text-[#64ffda]" />
                <a
              ...
              <li className="flex items-center">
                <MapPin className="w-6 h-6 mr-3 text-[#64ffda]" />
          ...
          <div>
            ...
            <form className="flex space-x-3">
              ...
              <Button
                type="submit"
                className="bg-[#64ffda] text-[#0a192f] hover:bg-[#45e0c0] transition-colors duration-300"
              >
